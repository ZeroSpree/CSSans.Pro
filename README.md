...
1. You will need a working [`Jekyll`](https://jekyllrb.com/) environment and [`NPM`](https://www.npmjs.com/) installed on your machine. Once you have installed NPM, you will need to install `gulp` into your global root directory if you haven't already: `npm install -g gulp`.
